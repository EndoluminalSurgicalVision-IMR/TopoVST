...
from src.dataset.adasire_datasets import AdaSIREAorta24Data
...
class AdaSIRETrackerAorta24TrainConfig(BaseConfig):
    ...
    dataset = AdaSIREAorta24Data
    dataset_name = "Aorta24"
    src_dir = ""  # User-defined
    # NOTE: sample CSV files should be generated in advance!
    samples = {
        "train": {
            "on_centerline": "tmp_data/samples/Aorta24_train_on_centerline_raware_multidir.csv",
            "off_centerline": "tmp_data/samples/Aorta24_train_off_centerline_raware_multidir.csv",
            "out_lumen": "tmp_data/samples/Aorta24_train_out_lumen.csv",
        },
        "val": {
            "on_centerline": "tmp_data/samples/Aorta24_val_on_centerline_raware_multidir.csv",
        }
    }
    window_level = 200
    window_width = 1200  # Following SIRE original paper
    train_samples = 20000
    val_samples = 500
...
if __name__ == "__main__":
    ...
    config = AdaSIRETrackerAorta24TrainConfig()
